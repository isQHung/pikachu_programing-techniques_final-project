...
bool Icheck_1(Normal** board, int p1, int p2, int q1, int q2) {
    if (p1 == q1) {
        int y, x, dem = 0;
        if (p2 > q2) {
            x = q2;
...
bool Lcheck(Normal** board, int p1, int p2, int q1, int q2) {
    if (p1 == q1 || p2 == q2) {
        return false;
    }
    bool c1, c2;
...
bool Zcheck(Normal** board, int p1, int p2, int q1, int q2) {
    if (p1 == q1 || p2 == q2) {
        return false;
    }
    bool c1, c2, c3;
...
bool Ucheck(Normal** board, int p1, int p2, int q1, int q2) {
...
bool allcheck(Normal** board, int p1, int p2, int q1, int q2) {

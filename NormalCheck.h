...
#include "Struct.h"
bool nextcheck(Normal**, int p1, int p2, int q1, int q2);
bool linecheck(Normal**, int p1, int p2, int q1, int q2);
bool Icheck_1(Normal**, int p1, int p2, int q1, int q2);
bool Lcheck(Normal**, int p1, int p2, int q1, int q2);
